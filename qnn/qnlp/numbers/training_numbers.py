...
from qnn.qnlp.numbers.circuits_numbers import sample_run_global, cc_1234567_bitstring
from qnn.qnlp.numbers.optimization import cost_global, g_parameter_shift_global
